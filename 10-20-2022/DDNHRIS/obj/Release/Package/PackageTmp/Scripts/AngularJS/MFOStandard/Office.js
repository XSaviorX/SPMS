...
app.controller("MFOStandard", function ($scope, $http, filterFilter) {
    ...
    s.sendRequest = function (mfoData, indicatorData, standardData, todayDate) {
        ...
        //$http.post('../MFOStandard/MFO_trygetMFO_allSI', { MFO_ID: data[0].MFOId }).then(function (response) {
        //    s.origData = response.data;
        //    // alert(s.origData.length);
        //    //console.log(s.origData);
        //    checkChanges(s.origData, todayDate);
        //}, function (err) {
        //    alert("error item");
        //});


        //alert(JSON.stringify(s.origData));
