<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IPCR_TARGET.aspx.cs" Inherits="DDNHRIS.Reports.SPMS.IPCR_TARGET1" %>
...
<body>
    <form id="form1" runat="server">
        <div>
                <telerik:ReportViewer ID="IPCRViewer" runat="server" ViewMode="PrintPreview" Width="100%" Height="8000px"></telerik:ReportViewer>
