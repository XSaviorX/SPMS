<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IPCR_ACTUAL.aspx.cs" Inherits="DDNHRIS.Reports.SPMS.IPCR_ACTUAL1" %>
...
<body>
    ...
    <div>
        <telerik:ReportViewer ID="ActualViewer" runat="server" ViewMode="PrintPreview" Width="100%" Height="8000px"></telerik:ReportViewer>
    </div>
    </form>
