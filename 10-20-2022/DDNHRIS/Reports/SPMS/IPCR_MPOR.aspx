<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IPCR_MPOR.aspx.cs" Inherits="DDNHRIS.Reports.SPMS.IPCR_MPOR1" %>
...
<body>
    ...
    <div>
        <telerik:ReportViewer ID="MPORViewer" runat="server" ViewMode="PrintPreview" Width="100%" Height="8000px"></telerik:ReportViewer>
    </div>
    </form>
