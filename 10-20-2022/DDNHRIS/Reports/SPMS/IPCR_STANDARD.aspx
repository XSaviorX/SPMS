<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IPCR_STANDARD.aspx.cs" Inherits="DDNHRIS.Reports.SPMS.IPCR_STANDARD1" %>
...
<body>
    ...
    <div>
        <telerik:ReportViewer ID="IPCR_STANDARDViewer" runat="server" ViewMode="PrintPreview" Width="100%" Height="8000px"></telerik:ReportViewer>
    </div>
    </form>
