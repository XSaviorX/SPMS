<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Opcr.aspx.cs" Inherits="DDNHRIS.Reports.SPMS.Opcr" %>
...
<body>
    <form id="form1" runat="server">
        <div>
                <telerik:ReportViewer ID="OPCRViewer" runat="server" ViewMode="PrintPreview" Width="100%" Height="8000px"></telerik:ReportViewer>
