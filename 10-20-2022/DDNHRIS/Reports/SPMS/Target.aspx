<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Target.aspx.cs" Inherits="DDNHRIS.Reports.SPMS.Target1" %>
...
<body>
    ...
    <div>
         <telerik:ReportViewer ID="TargetViewer" runat="server" ViewMode="PrintPreview" Width="100%" Height="8000px"></telerik:ReportViewer>
