        ...
        protected void Page_Load(object sender, EventArgs e)    
        {
            ...
            switch (reportType)
            {
                ...
                case "PlantillaCSCForm":
                    rpt.ReportDocument = new DDNHRIS.Reports.Plantilla.PlantillaPropCSC();
                    rpt.Parameters.Add("paramCode", paramCode);
                    break; //PlantillaPropCSC

                case "CSC_U_PLANTILLA":
                    rpt.ReportDocument = new DDNHRIS.Reports.Plantilla.PlantillaPropCSCUnfunded();
                    rpt.Parameters.Add("paramCode", paramCode);
                    break;
                ...
                case "EMPOFFICEWORKGROUPPLANTILLA":
                    var gCode = Session["PrintReport"].ToString();   
                    rpt.ReportDocument = new DDNHRIS.Reports.UtilityReport.EmployeeByWorkGroupPlantilla();
                    rpt.Parameters.Add("paramWorkGroupCode", gCode);
                    break;
